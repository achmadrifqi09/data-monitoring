        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <button type="button" id="darkModeButton"
                    ...
                    <span id="lightIcon">
                        <x-solar-sun-bold class="w-5 h-5 dark:text-white text-gray-500 block dark:hidden" />
                    </span>
                </button>
                <div class="flex items-center ms-3 relative">
                    ...
                    <div class="z-50 hidden min-w-40 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="dropdown-user">
