...
@section('content')
    <div class="mb-8 mt-4 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
        ...
        <div class="inline-flex h-max rounded-sm" role="group">
            <button
                type="button"
                data-modal-target="create-bpl"
                data-modal-toggle="create-bpl"
            ...
            <button
                type="button"
                data-modal-target="import-bpl"
                data-modal-toggle="import-bpl"
                ...
                >
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-4">
                            <button
                                class="edit-button font-semibold text-yellow-400"
                                data-modal-target="edit-bpl"
                                data-modal-toggle="edit-bpl"
                                data-partner="{{ json_encode($item) }}"
                            >
                                Edit
                            </button>
                            <button
                                class="bpl-delete-confirm font-semibold text-red-500"
                                data-id="{{ $item->id }}"
                            >
                                Hapus
                            </button>
