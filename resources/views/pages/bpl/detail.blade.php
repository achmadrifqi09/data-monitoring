    ...
    <div>
        ...
        <div class="mt-6 bg-white border border-gray-200 dark:border-none dark:bg-clay p-4 rounded-lg">
            ...
            <div class="mt-6 flex gap-2">
                @can('bpl_update')
                    <button type="button"
                            data-modal-target="update-bpl" data-modal-toggle="update-bpl"
            ...
            <x-modal id="update-bpl" title="Update Item BPL">
                <x-slot name="content">
                    <form method="post" id="update-bpl-item-form" action="/bpl/{{$bpl->id}}">
                        @method('PATCH')
                        @csrf
                        <x-input-label id="bpl_number" label="Nomor BPL" name="bpl_number"
                                       placeholder="Masukkan nomor BPL" value="{{$bpl->bpl_number}}"
                                       required min="1"/>
                        <x-input-label id="description" label="Uraian *" name="description"
                                       placeholder="Masukkan uraian" value="{{$bpl->description}}"
                                       required/>
