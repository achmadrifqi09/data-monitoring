    ...
    <main class="flex h-dvh w-full items-center justify-center px-4 md:px-0">
        ...
        >
            <div class="mb-8 flex items-center gap-4">
                <div class="outline-1.5 w-max rounded-full bg-red-300 p-2 dark:bg-red-700">
                    <div class="rounded-full bg-red-600 p-2 dark:bg-red-800 shadow-md">
                        <x-solar-lock-password-unlocked-bold class="h-6 w-6 text-white" />
                    </div>
                </div>
                <div>
                    <h3 class="text-2xl font-semibold">Login</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Monitoring data</p>
                </div>
            </div>
