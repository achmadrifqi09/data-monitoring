...
@section('content')
    <div class="mb-8 mt-4 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
        ...
        <div class="inline-flex h-max rounded-sm" role="group">
            <button type="button" data-modal-target="create-partner" data-modal-toggle="create-partner"
            ...
            <button type="button" data-modal-target="import-partner" data-modal-toggle="import-partner"
